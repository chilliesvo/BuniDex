...
contract TKPoolJoinExitNoFee is BNum {
    ...
    function joinPool(uint poolAmountOut, uint poolTotal, uint _records_t_balance) internal pure returns (uint) {
    ...
    function exitPoolNoFee(uint poolAmountIn, uint poolTotal, uint _records_t_balance) internal pure returns (uint) {
