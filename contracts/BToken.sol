...
contract BTokenKase is BNum {
    ...
    event BApproval(address indexed src, address indexed dst, uint amt);
    event BTransfer(address indexed src, address indexed dst, uint amt);

    function _mint(uint amt) internal {
        _balance[address(this)] = badd(_balance[address(this)], amt);
        _totalSupply = badd(_totalSupply, amt);
        emit BTransfer(address(0), address(this), amt);
    }
    ...
    function _burn(uint amt) internal {
        ...
        emit BTransfer(address(this), address(0), amt);
    }
