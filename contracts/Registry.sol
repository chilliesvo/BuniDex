...
contract KRegistry {
    ...
    function _createKey(address token1, address token2) internal pure returns (bytes32) {
        uint128 uintToken1 = uint128(uint160(token1));
        uint128 uintToken2 = uint128(uint160(token2));
        return
            bytes32(
                (uint256(uint128((uintToken1 < uintToken2) ? uintToken1 : uintToken2)) << 128) |
                    (uint256(uint128((uintToken1 < uintToken2) ? uintToken2 : uintToken1)))
            );
    }
